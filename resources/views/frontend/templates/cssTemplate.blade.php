...
<link href="{{asset('public/assets/css/jqueryConfirm.min.css')}}" rel="stylesheet" type="text/css" />
...
<link rel="icon" type="image/png" sizes="96x96" href="{{asset('public/email/images/favicon.png')}}">
<link rel="stylesheet" type="text/css" href="{{asset('public/assets/css/jquery.datetimepicker.css')}}"/>
